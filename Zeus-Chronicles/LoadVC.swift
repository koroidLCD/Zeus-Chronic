...
class LoadVC: UIViewController, URLSessionDelegate {
    ...
    func setupUI() {
        ...
        for i in 0..<20 {
            ...
            squareView.backgroundColor = (i > Int(secondsRemaining)) ? UIColor(ciColor: .clear) : UIColor(ciColor: .yellow)
    ...
    @objc func updateTimer() {
        ...
        for i in self.squareViews {
            i.backgroundColor = (i.tag > Int(self.secondsRemaining)) ? UIColor(ciColor: .clear) : UIColor(ciColor: .yellow)
        }
